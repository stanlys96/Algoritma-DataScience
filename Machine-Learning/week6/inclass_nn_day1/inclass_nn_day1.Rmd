...
2. **Feed Forward**  
   Data input diproses untuk menghasilkan prediksi.
...
- **Linear**  
  ...
  - Cocok untuk output layer pada kasus regresi (range: -∞ ~ ∞).  
...
- **ReLU (Rectified Linear Unit)**  
  ...
  - Cocok di hidden layer untuk kasus data citra (range: 0 ~ ∞).
