...
The dataset was collected in 1960 and a full description of the dataset was available in [here](https://search.r-project.org/CRAN/refmans/ACSWR/html/usc.html). I use the description I gathered from the authors of the MASS package. After you rename the dataset (in your coursebook, around line 410 to line 420), the variables are:  
