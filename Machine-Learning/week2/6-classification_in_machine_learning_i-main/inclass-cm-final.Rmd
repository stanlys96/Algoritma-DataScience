...
- Positif : Gagal Bayar (1)
- Negatif : Berhasil Bayar (0)
...
Sehingga ambil metriks evaluasi: Recall/Sensitivity (Meminimalisir FN)
...
1. jumlah data 400
  ...
  - k = sqrt(400) = 20 -> 19 atau 21

2. jumlah data 900
  - (low, medium, high) -> kelas target = 3 
  - k = sqrt(900) = 30 -> 28 atau 32
